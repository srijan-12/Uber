...
export const CaptainRideFinish = () =>{
    return(
            
        <>
             <div className="h-[100%] bg-white absolute w-full top-[0%] mb-0 p-4 flex flex-col" >

                <h1 className="text-3xl font-medium font-bold p-2 mb-3">Finish this ride</h1>
                ...
                <Link to='/home-captain' className="w-full bg-[#56C97D] p-4 rounded-lg text-white text-center font-semibold text-lg my-3">Finish</Link>
            </div>
        </>
    )
}