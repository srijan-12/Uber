...
export const LocationHistory = ({setConfirmRidePannelShow, setFindTripPannel, setShowPannel, pannelRef}) =>{
    const handleClick = () =>{
        setShowPannel(false)
    ...
    return(
        <>
            {locations.map((location,index)=>{
                return(
                <div className="w-full flex px-4 py-2 items-center gap-4 my-2 border-2 border-grey-100 active:border-2 active:border-black rounded-lg" key={index} onClick={handleClick}> 
